...
이 파일은 Codex가 작업 시작 전에 읽는 **경량 런타임 계약서**다.
...
Rules:
- Always read graphify-out/GRAPH_REPORT.md first before answering project-related questions or starting repository work
