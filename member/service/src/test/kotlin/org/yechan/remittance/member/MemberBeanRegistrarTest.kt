    ...
    fun `자동 설정은 member use case 빈을 등록한다`() {
        val context = AnnotationConfigApplicationContext().apply {
            ...
            beanFactory.registerSingleton(
                "passwordHashEncoder",
                mock(PasswordHashEncoder::class.java),
            )
        ...
        assertThat(context.getBean(MemberAuthenticationQueryUseCase::class.java)).isInstanceOf(
            MemberAuthenticationQueryService::class.java,
        )
        assertThat(context.getBean(MemberExistenceQueryUseCase::class.java)).isInstanceOf(
            MemberExistenceQueryService::class.java,
        )
