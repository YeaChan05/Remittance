...
class MemberRepositoryImpl(
    ...
    override fun save(props: MemberProps): MemberModel = repository.save(MemberEntity.create(props))
    ...
    override fun findByEmail(email: String): MemberModel? = repository.findByEmail(email)
}
