...
class LedgerEntity protected constructor() : BaseEntity(), LedgerModel {
    ...
    companion object {
        fun create(props: LedgerProps): LedgerEntity {
            return LedgerEntity(props.transferId, props.accountId, props.amount, props.side)
        }
    }
}
